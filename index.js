...
console.log( "nuevo", JSON.stringify(normalizeEmpresa).length);

//Desnormalizada:

const desnomalizadaDate = denormalize(normalizeEmpresa.result, organigrama, normalizeEmpresa.entities)
print(desnomalizadaDate)